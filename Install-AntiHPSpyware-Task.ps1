...
$TaskURI = ([xml](Get-Content -Path .\sources\DisableHPAnalytics-Job.xml)).Task.RegistrationInfo.URI
...
schtasks.exe /Create /XML .\sources\DisableHPAnalytics-Job.xml /TN $TaskURI
